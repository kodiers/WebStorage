...
$guru['product_minorversion']   = 1;
$guru['product_revision']       = 9;
$guru['product_suffix']         = '';
...
$guru['master_servers']		= array(
 'US' => 'alpha.zfsguru.com/',
 'EU' => 'bravo.zfsguru.com/'
);
$guru['remote_version_url']	= 'zfsguru_version.txt';
$guru['remote_update_version']	= 1;
$guru['remote_system_url']	= 'zfsguru_system.txt';
$guru['remote_system_ident']	= 'systemimage';
$guru['remote_system_version']	= 1;
$guru['remote_services_url']	= 'zfsguru_services.txt';
$guru['remote_services_version'] = 1;
...
*/
$guru['configuration_file']     = $guru['docroot'] . 'config/config.bin'; // was '/config/config.bin'
...
$guru['required_binaries'] = array(
 'Tar' => '/usr/bin/tar',
 'Sudo' => '/usr/bin/sudo',	// old value /usr/local/bin/sudo
 'sh' => '/bin/sh'
);
$guru['path'] = array(
